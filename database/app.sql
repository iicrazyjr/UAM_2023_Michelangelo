...
/*!40000 DROP DATABASE IF EXISTS `app`*/;
...
CREATE TABLE `users` (
  ...
  `Password` char(255) NOT NULL DEFAULT 'SXDqsdff12334SSWQFHGJGJSLA',
  PRIMARY KEY (`ID`)
...
set autocommit=0;
INSERT INTO `users` VALUES (1, 'admin', SHA2('hispasec_*!torneopingpong!*_koodous*1_-peachesIloveU', 256));
INSERT INTO `users` VALUES (2, 'raul', SHA2('sstime', 256));
INSERT INTO `users` VALUES (3, 'adrian', SHA2('sstiffanyss', 256));
INSERT INTO `users` VALUES (4, 'fernando', SHA2('ghinassti', 256));
INSERT INTO `users` VALUES (5, 'jonathan', SHA2('lamissti', 256));
